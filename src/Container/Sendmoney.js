...
const Sendmoney = (props) => {
  ...
  const getData = async (e) => {
    ...
    const starCountRef = ref(db, "customer2/");
  ...
  return (
    <>
      <form method="" className="  vertical-center-row    g-4  container mt-5">
        ...
        <div className="col-12 mt-5 d-flex justify-content-evenly">
          <button
